...
Instead of wrapping the entire presentation into a giant object body,
slides are written linearly:
...
* giant monolithic wrappers
* excessive abstraction
* complicated theme systems
* heavy beamer-style architecture

The goal is:

small + composable + readable
